		...
		<div id="content">
			<div id="header">
				<span class="icon_flag">
					...
					<a href="${request.contextPath}/manage/config/mewsConfig" title="二级菜单设置">新闻设置</a>&nbsp;&nbsp;
				</span>
			</div>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr id="thead">
					<td width="50%" class="left">新闻设置</td>
					<td width="50%">是否显示</td>
				</tr>
				<#list newsList as n>
					<tr bgColor="#<#if (0 == n_index % 2)>F9F9F9<#else>FFFFFF</#if>" onMouseOver="changeBgColor(this, '#ECECEC');" onMouseOut="changeBgColor(this, '#<#if (0 == n_index % 2)>F9F9F9<#else>FFFFFF</#if>');">
						...
						<td><input class="newsconfig" type="checkbox" name="target" value="${n.configId}" <#if (1 == n.configVisible)>checked</#if>></td>
					</tr>
				</#list>
			</table>
		</div>
